...
def test__create_bank_account__empty_name__return_http_422():
    empty_name = ''
...
def test__create_bank_account__unsupported_type__return_user_error_2():
    ...
    assert result['errors']['json']['type'][0] == USER_ERR_2


def test__create_bank_account__unsupported_type__return_http_422():
    unsupported_type = 'UNSUPPORTED_TYPE'
...
def test__rename_bank_account__empty_name__return_http_422():
    name = 'BA1'
