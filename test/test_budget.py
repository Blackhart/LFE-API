...
from api.test.utils.budget import delete_budget
from api.test.utils.budget import rename_budget
from api.test.utils.budget import list_budgets
from api.test.utils.budget import get_budget
from api.test.utils.budget import get_linked_bank_accounts
from api.test.utils.budget import get_linked_budget_groups
...
def test__create_budget__empty_name__return_user_error_1():
    empty_name = ''
...
def test__create_budget__empty_name__return_http_422():
    empty_name = ''
...
def test__rename_budget__empty_name__return_http_422():
    created = create_budget().json()
