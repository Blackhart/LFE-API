from api.data.constant import USER_ERR_1, USER_ERR_4, USER_ERR_9
...
def test__delete_budget_category__non_existing_category__return_user_error_3():
    ...
    assert result['id'][0] == USER_ERR_9.format(id=id)
...
def test__get_budget_category__non_existing_category__return_user_error_3():
    ...
    assert result['id'][0] == USER_ERR_9.format(id=non_existing_category)
